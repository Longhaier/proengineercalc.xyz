...
export const metadata = {
  title: '使用条款 - 智效厂务工程计算器',
  description: '智效厂务工程计算器使用条款 - 专业工程师计算工具箱',
}
      ...
      <main className="container">
        <div className="calculator-container">
          ...
          <div className="content-section">
            ...
            <h3>1. 条款接受</h3>
            <p>访问和使用智效厂务工程计算器，即表示您同意并接受本协议的所有条款和规定。</p>

            <h3>2. 使用许可</h3>
            <p>本网站的许可是临时性的，仅供个人、非商业性浏览使用。这是对许可的授予，而非所有权的转移。</p>

            <h3>3. 免责声明</h3>
            <p>本网站按"原样"提供，不提供任何明示或暗示的陈述或担保。智效厂务工程计算器对本网站上的信息、材料及相关内容不作任何陈述或担保。</p>

            <h3>4. 责任限制</h3>
            <p>对于以下情况，智效厂务工程计算器不承担任何责任：</p>
            <ul>
            ...
            <h3>6. 知识产权</h3>
            <p>本网站上的所有内容，包括计算器、公式和文档，均为智效厂务工程计算器的知识产权，除非另有说明。</p>
