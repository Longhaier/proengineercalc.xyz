    ...
    <>
      ...
      <main className="container">
        <div className="calculator-container">
          <h1 style={{ fontSize: '1.75rem', fontWeight: 700, margin: '2rem 0 1rem' }}>Pipe Pressure Loss</h1>
          <div className="calculator-form">
            ...
            {result && (
              <div className="result-group">
                ...
                <div className="result-item"><span className="result-label">Pressure Loss</span><span className="result-value">{result.pressureLoss} kPa</span></div>
              </div>
            )}
          </div>
